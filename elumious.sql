...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 28, 2021 at 10:43 PM
...
(10, '2020_11_19_142622_create_user_registers_table', 1);
...
CREATE TABLE `user_registers` (
  ...
  `user_about_me` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_date_of_birth` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
